...
# e-mail address for Clearance to send notifications from
DO_NOT_REPLY = "do_not_reply@opengovernment.org"
...
Rails::Initializer.run do |config|
  ...
  config.load_paths += %W( #{RAILS_ROOT}/app/models/committees #{RAILS_ROOT}/app/models/chambers )
