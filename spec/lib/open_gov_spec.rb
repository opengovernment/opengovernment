...
describe OpenGov::Resources do
  context ".valid_date!" do
    it "should return a valid date given a float" do
      OpenGov::Resources::valid_date!(1242187200.0).should eql(Date.parse("Tue, 12 May 2009"))
    end

    it "should return a date given a string" do
      OpenGov::Resources::valid_date!("Tue, 12 May 2009").should eql(Date.parse("Tue, 12 May 2009"))
    end
